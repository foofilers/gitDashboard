...
(function ($) {
    ...
    $.layout = {
        ...
        version: "1.3.rc29.15", revision: 0.032915 // 1.3.0 final = 1.0300 - major(n+).minor(nn)+patch(nn+)

        // LANGUAGE CUSTOMIZATION
        , language: {
            //	Tips and messages for resizers, togglers, custom buttons, etc.
            Open: "Open"	// eg: "Open Pane"
            , Close: "Close", Resize: "Resize", Slide: "Slide Open", Pin: "Pin", Unpin: "Un-Pin", noRoomToOpenTip: "Not enough room to show this pane."
        ...
        , browser: {
            ...
            , msie: !!$.browser.msie, isIE6: !!$.browser.msie && $.browser.version == 6, boxModel: false	// page must load first, so will be updated set by _create
    ...
    $.fn.layout = function (opts) {
        ...
        // DEFAULT OPTIONS - CHANGE IF DESIRED
            , options = {
                ...
                , defaults: { // default options for 'all panes' - will be overridden by 'per-pane settings'
                    ...
                    paneSelector: ".ui-layout-north", size: "auto"		// eg: "auto", "30%", 200
        ...
        // DYNAMIC DATA - IS READ-ONLY EXTERNALLY!
            , state = {
                ...
                , north: {}, south: {}, east: {}, west: {}, center: {}, cookie: {} // State Managment data storage
            }


        // INTERNAL CONFIG DATA - DO NOT CHANGE THIS!
            , _c = {
                allPanes: "north,south,west,east,center", borderPanes: "north,south,west,east", altSide: {
         ...
         */
            , cssMinDims = function (pane) {
                ...
                var
                    dir = _c[pane].dir
                    , d = {
                        minWidth: 1001 - cssW(pane, 1000), minHeight: 1001 - cssH(pane, 1000)
                    }
                    ;
            ...
            , initResizable = function (panes) {
                ...
                $.each(panes.split(","), function (idx, pane) {
                    ...
                    $R.draggable({
                        ...
                        , zIndex: _c.zIndex.resizer_drag, start: function (e, ui) {
                            ...
                            $Frames.each(function () {
                                ...
                                $('<div id="' + id + '" class="ui-layout-mask ui-layout-mask-' + pane + '"/>')
                                    .css({
                                        background: "#fff", opacity: "0.001", zIndex: _c.zIndex.iframe_mask, position: "absolute", width: this.offsetWidth + "px", height: this.offsetHeight + "px"
                                    })
            ...
            , swapPanes = function (pane1, pane2) {
                ...
                function copy(n) { // n = pane
                    var
                        ...
                        ;
                    return !$P ? false : {
                        pane: n, P: $P ? $P[0] : false, C: $C ? $C[0] : false, state: $.extend({}, state[n]), options: $.extend({}, options[n])
                    }
                };
        ...
        var Instance = {
            ...
            , enableClosable: enableClosable, disableClosable: disableClosable, enableSlidable: enableSlidable, disableSlidable: disableSlidable, enableResizable: enableResizable, disableResizable: disableResizable
        };
